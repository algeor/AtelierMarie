        ...
        {isLoading ? (
          ...
          <>
            ...
            <StatsCard
              ...
              countValue={stats.revenue_this_week_cents}
              valueFormatter={(value) => formatPrice(Math.round(value))}
              icon={
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-6 w-6">
            ...
            <StatsCard
              ...
              countValue={stats.active_product_count}
              icon={
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-6 w-6">
